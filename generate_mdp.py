...
# generate belief state space for a two state POMDP formed by taking action R and B in states 0 and 1 to with Tr  and Tb as transition probability matrix corresponding to actions R and B and Cr and Cb cost vectors corresponding to actions R and B.
# The belief state space is generated by taking the convex combination of the belief states corresponding to the two states 0 and 1.
